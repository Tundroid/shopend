...
from sqlalchemy import Column, String, SmallInteger, Integer, Date, Text, TIMESTAMP, ForeignKey
...
class RecordDetail(BaseModel, Base):
    ...
    if models.storage_t == "db":
        ...
        source_depot_rel = relationship('DepotDetail', foreign_keys=[source_depot], backref='source_record_details')
        dest_depot_rel = relationship('DepotDetail', foreign_keys=[dest_depot], backref='dest_record_details')
