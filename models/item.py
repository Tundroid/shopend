...
class Item(BaseModel, Base):
    ...
    if models.storage_t == "db":
        ...
        item_cat = Column(SmallInteger, ForeignKey('mole_commerce.item_cat.id'), nullable=False, default=1)
        ...
        family = Column(SmallInteger, ForeignKey('mole_commerce.family.id'), nullable=False, default=1)
        sector = Column(SmallInteger, ForeignKey('mole_commerce.sector.id'), nullable=False, default=1)
